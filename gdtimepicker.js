Vue.component('gdtimepicker', {
  ...
  ,data: function() { return({ tmStr: '9:00 AM' }); }
  ,computed: {
  ...
  ,created: function () { // setting component data objects from props params
     this.tmStr = this.value;
  }
  ,template: `<div class="gd-tp-dropdown"><slot></slot><input type="text" v-model="tmStr" @keyup="emitIt">
